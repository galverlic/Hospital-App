  ...
  return (
    <div style={{ maxWidth: 600, margin: "40px auto", fontFamily: "system-ui" }}>
      ...
      <ul style={{ padding: 0, listStyle: "none" }}>
        {doctors.map(d => (
          <li key={d.id} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "10px 0", borderBottom: "1px solid #eee" }}>
            <span style={{ fontSize: 16 }}>{d.name}</span>
            <button onClick={() => del(d.id)} style={{ padding: "4px 10px", background: "#e74c3c", color: "white", border: "none", borderRadius: 4, cursor: "pointer" }}>
              Delete
            </button>
          </li>
        ))}
        ...
        {doctors.map(d => (
          <li key={d.id} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "10px 0", borderBottom: "1px solid #eee" }}>
            ...
            <div style={{ display: "flex", gap: 8 }}>
              ...
              <button onClick={() => del(d.id)} style={{ background: "#e74c3c", color: "white", border: "none", padding: "4px 10px", borderRadius: 4 }}>Delete</button>
            </div>
          </li>
        ))}
      </ul>
